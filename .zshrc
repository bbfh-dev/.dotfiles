...
export PATH=$HOME/bin:/usr/local/bin:$HOME/.local/bin:/home/main/.cargo/bin:~/go/bin:$PATH
...
alias git-bubblefish='git config --global user.email "daforsastudia@gmail.com"; git config --global user.name "BubbleFish"'
...
function create {
  mkdir ~/public/git/local/$1
}

alias x="sh ~/.local/bin/quickrun.sh"
alias xp="sh ~/.local/bin/quickrun.sh --parent"
alias xc="sh ~/.local/bin/quickrun.sh --modify"
alias g-bbfh="cp ~/.git-credentials.bbfh-dev ~/.git-credentials"
